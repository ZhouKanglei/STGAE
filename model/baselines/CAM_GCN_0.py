...
from tensorflow.keras.layers import Conv1D, Activation, Dropout, Input, Add, BatchNormalization
...
class CAM_GCN(Model):
    ...
    def __init__(self):
        ...
        # WaveNet
        self.wavenet = wavenet(n_filters=64,
                               filter_width=2,
                               n_layers=7,
                               dropout=0.2)

        self.g1 = gcn(filters=128,
                       t_kernel_size=1,
                       layer_no=0,
                       A=self.A)

        self.g2 = gcn(filters=32,
                      t_kernel_size=1,
                      layer_no=0,
                      A=self.A)
